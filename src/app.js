...
async function fetchChapterTopics(chapterKey) {
    const topicMap = {
        ...
        "capitulo-2": [
            ...
            {file: "06-inmutabilidad-avanzada.md", title: "Inmutabilidad Avanzada"},
            {file: "07-shallow-equality.md", title: "Shallow Equality"},
        ],
        "capitulo-3": [
            {file: "01-motores-modernos.md", title: "Motores Modernos 2025"},
            {file: "02-memory-management-gc.md", title: "Memory Management"},
            ...
            {
                file: "06-monomorfismo-vs-polimorfismo.md",
                title: "Monomorfismo vs Polimorfismo",
            },
            {file: "07-optimizacion-motor.md", title: "Optimización de Código"},
        ],
        "capitulo-4": [
            {file: "01-objetos-manipulacion.md", title: "Creación y Manipulación de Objetos"},
            ...
            {file: "05-clases-extends-super.md", title: "Clases ES6+"},
            {file: "06-encapsulacion-privacidad.md", title: "Encapsulación"},
            {
                file: "07-polimorfismo-composicion.md",
                title: "Polimorfismo y Composición",
            },
            {file: "08-symbols-metaprogramacion.md", title: "Symbols y Metaprogramación"},
            {file: "09-patrones-diseno.md", title: "Patrones de Diseño"},
        ],
        "capitulo-5": [
            {file: "01-destructuring-profundo.md", title: "Destructuring Profundo"},
            {file: "02-spread-rest-avanzado.md", title: "Spread/Rest Avanzado"},
            {file: "03-metodos-arrays-avanzados.md", title: "Métodos Avanzados de Arrays"},
            {file: "04-iterators-generators.md", title: "Iterators y Generators"},
            {file: "05-for-in-vs-for-of.md", title: "for...in vs for...of"},
            {file: "06-weakmap-weakset.md", title: "WeakMap y WeakSet"},
            {file: "07-json-avanzado.md", title: "JSON Avanzado"},
            {file: "08-clonacion-profunda.md", title: "Clonación Profunda"},
        ],
        "capitulo-6": [
            {
            ...
            {file: "02-eventos-delegation.md", title: "Eventos y Event Delegation"},
            {file: "03-ciclo-render-reflow-repaint.md", title: "Reflow y Repaint"},
            ...
            {file: "07-virtual-dom-basico.md", title: "Virtual DOM Básico"},
        ],
        "capitulo-7": [
            {file: "01-callbacks-hell.md", title: "Callback Hell"},
            {file: "02-promises-microtasks.md", title: "Promises y Microtasks"},
            {file: "03-async-await-avanzado.md", title: "Async/Await Avanzado"},
            {file: "04-event-loop-macrotasks.md", title: "Event Loop"},
            {file: "05-fetch-api-streaming.md", title: "Fetch API y Streaming"},
            {file: "06-abort-controller.md", title: "AbortController"},
            {file: "07-manejo-errores-async.md", title: "Manejo de Errores Async"},
            {file: "08-websockets-basico.md", title: "WebSockets Básico"},
            {file: "09-web-workers.md", title: "Web Workers"},
        ],
        "capitulo-8": [
            {file: "01-es-modules.md", title: "ES Modules"},
            {file: "02-organizacion-features-vs-layers.md", title: "Organización de Código"},
            {file: "03-mvc-javascript.md", title: "MVC en JavaScript"},
            {file: "04-mvvm-separacion-responsabilidades.md", title: "MVVM"},
            {file: "05-dependency-injection.md", title: "Dependency Injection"},
            {file: "06-clean-architecture-basica.md", title: "Clean Architecture"},
        ],
        "capitulo-9": [
            {file: "01-big-o-notation.md", title: "Big-O Notation"},
            {file: "02-listas-colas-pilas.md", title: "Listas Enlazadas"},
            {file: "03-hash-tables.md", title: "Hash Tables"},
            {file: "04-arboles-bst.md", title: "Árboles (BST)"},
            {file: "05-grafos-basico.md", title: "Grafos Básico"},
            {file: "06-recursividad-profunda.md", title: "Recursividad Profunda"},
            {file: "07-memoizacion.md", title: "Memoización"},
            {file: "08-optimizacion-algoritmica.md", title: "Optimización Algorítmica"},
        ],
        "capitulo-10": [
        ...
        "capitulo-15": [
            ...
            {file: "07-seguridad-fetch-apis.md", title: "Seguridad en Fetch"},
            {file: "08-hardening-frontend.md", title: "Hardening Frontend"},
            {file: "09-seguridad-dependencias.md", title: "Seguridad de Módulos"},
        ],
        "capitulo-16": [
            {file: "01-bundlers-modernos.md", title: "Bundlers Modernos"},
            {file: "02-tree-shaking-code-splitting.md", title: "Tree Shaking"},
            ...
            {file: "06-deploy-plataformas.md", title: "Deploy"},
            {file: "07-ci-cd-buenas-practicas.md", title: "CI/CD"},
        ],
    };
